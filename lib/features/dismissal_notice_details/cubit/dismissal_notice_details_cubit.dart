...
part 'dismissal_notice_details_state.dart';

class DismissalNoticeDetailsCubit extends Cubit<DismissalNoticeDetailsState> {
  DismissalNoticeDetailsCubit() : super(DismissalNoticeDetailsInitial());
