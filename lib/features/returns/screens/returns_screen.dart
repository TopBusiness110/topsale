                ...
                child: Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      state is ClientCartFounded ||
                              state is AddedState ||
                              state is ProductRemoved ||
                              state is RemoveState
                          ?
                                                    ...
                                                    children: [
                                                      Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          Text(
                                                            "${cubit.listOfProducts[index].listPrice} USD",
                                                            textDirection:
                                                                TextDirection
                                                                    .ltr,
                        ...
                        itemBuilder: (context, index) {
                          return InkWell(
                            onTap: () {
                              ...
                              cubit.searchForProductsForClient(
                                  cubit.currentClient,
                                  context.read<CartCubit>().cart);
                            },
                            child: Padding(
