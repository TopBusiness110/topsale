...
class EndPoints {
  ...
  static String allProducts =
      '$baseUrl/api/product.product/?query={id,name,categ_id,list_price,currency_id,taxes_id,uom_name,uom_id,description_sale,qty_available,image_1920}&page_size=10&limit=10&';
  ...
  static String getTaxes = '$baseUrl/api/account.tax/?query={id, display_name}&';
