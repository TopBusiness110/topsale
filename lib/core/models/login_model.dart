...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        ...
        webTours: json["web_tours"] == null
            ? []
            : List<dynamic>.from(json["web_tours"]!.map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "web_tours":
            webTours == null ? [] : List<dynamic>.from(webTours!.map((x) => x)),
...
class UserCompanies {
  ...
  factory UserCompanies.fromJson(Map<String, dynamic> json) => UserCompanies(
        ...
        allowedCompanies: Map.from(json["allowed_companies"]!).map((k, v) =>
            MapEntry<String, AllowedCompany>(k, AllowedCompany.fromJson(v))),
        disallowedAncestorCompanies:
            json["disallowed_ancestor_companies"] == null
                ? null
                : DisallowedAncestorCompanies.fromJson(
                    json["disallowed_ancestor_companies"]),
      );

  Map<String, dynamic> toJson() => {
        "current_company": currentCompany,
        "allowed_companies": Map.from(allowedCompanies!)
            .map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
...
class DisallowedAncestorCompanies {
  ...
  factory DisallowedAncestorCompanies.fromJson(Map<String, dynamic> json) =>
      DisallowedAncestorCompanies();
...
class UserSettings {
  ...
  factory UserSettings.fromJson(Map<String, dynamic> json) => UserSettings(
        ...
        volumeSettingsIds: json["volume_settings_ids"] == null
            ? []
            : List<List<dynamic>>.from(json["volume_settings_ids"]!
  ...
  Map<String, dynamic> toJson() => {
        ...
        "volume_settings_ids": volumeSettingsIds == null
            ? []
            : List<dynamic>.from(volumeSettingsIds!
                .map((x) => List<dynamic>.from(x.map((x) => x)))),
